...
const MOCK_YOUTUBE_VIDEOS: YouTubeVideo[] = [
    {
        ...
        thumbnail: 'https://i.ytimg.com/vi/2LhoCfjm8R4/default.jpg'
    },
    {
        videoId: '8hly31xKli0',
        ...
        thumbnail: 'https://i.ytimg.com/vi/8hly31xKli0/default.jpg'
    },
    {
        videoId: 'G3e-cpL7ofc',
        ...
        channelTitle: 'freeCodeCamp.org',
        thumbnail: 'https://i.ytimg.com/vi/G3e-cpL7ofc/default.jpg'
    }
]

export async function getYoutubeVideos(query: string = "indian student programming tutorials"): Promise<YouTubeVideo[]> {
