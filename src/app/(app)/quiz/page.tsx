...
import { Terminal, FileQuestion, BookCopy, Sparkles } from 'lucide-react';
        ...
        <div className="space-y-8">
            <div className="text-center">
                ...
                <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
                    Test your knowledge with quizzes from your mentors or generate one for self-evaluation.
                </p>
            </div>
                 ...
                 <Card>
                    <CardHeader>
                        <div className="flex items-center gap-2">
                            ...
                            <CardTitle>Self-Evaluation Quiz</CardTitle>
                        </div>
                        <CardDescription>Generate a quiz on a topic of your choice to test your knowledge.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <QuizClient />
                    </CardContent>
